...
struct TripDetailView: View {
    ...
    @StateObject var settlementVM = SettlementViewModel()
    @Environment(\.dismiss) private var dismiss

    // Real-time trip data
    @State var currentTrip: TripModel
    @State var tripListener: ListenerRegistration?
    ...
    @State var expenseSearchText = ""
    @State var selectedCategory: ExpenseCategory? = nil
    ...
    @State var userBalances: [UserBalance] = []
    ...
    @ViewBuilder
    var financialSummaryCardView: some View {
